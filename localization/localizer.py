...
class FrameLocalizer:
    ...
    def localize(self, current_frame: Any) -> dict[str, object] | None:
        ...
        try:
            ...
            aruco_result = {"method": "aruco", "H": None, "confidence": 0.0, "error": str(exc), "status": "FAILED_ARUCO", "message": str(exc)}
        ...
        if self.global_map is not None:
            try:
                ...
                map_result = {"method": "map_matching", "H": None, "confidence": 0.0, "error": str(exc), "status": str(exc).split(":", 1)[0], "message": str(exc)}
        ...
        if self.previous_frame is not None and self.previous_result is not None:
            try:
                ...
                frame_result = {"method": "frame_matching", "H": None, "confidence": 0.0, "error": str(exc), "status": str(exc).split(":", 1)[0], "message": str(exc)}
